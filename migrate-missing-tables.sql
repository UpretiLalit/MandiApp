-- ============================================
-- MandiApp - Missing Tables Migration
...
CREATE POLICY IF NOT EXISTS "Service role can manage buyers"
ON Buyers FOR ALL TO service_role
USING (true) WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "Buyers can read their own profile"
...
CREATE POLICY IF NOT EXISTS "Service role can manage vendors"
ON Vendors FOR ALL TO service_role
USING (true) WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "Anyone can read active vendors"
ON Vendors FOR SELECT TO authenticated
USING (IsActive = true AND IsVerified = true);

CREATE POLICY IF NOT EXISTS "Vendors can read their own profile"
ON Vendors FOR SELECT TO authenticated
USING (auth.uid()::text = Id);
...
CREATE POLICY IF NOT EXISTS "Service role can manage transporters"
ON Transporters FOR ALL TO service_role
USING (true) WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "Anyone can read available transporters"
...
CREATE POLICY IF NOT EXISTS "Buyers can read their own orders"
...
CREATE POLICY IF NOT EXISTS "Buyers can read their order items"
...
CREATE POLICY IF NOT EXISTS "Vendors can read their order items"
ON OrderItems FOR SELECT TO authenticated
...
CREATE POLICY IF NOT EXISTS "Buyers can read their payments"
...
CREATE POLICY IF NOT EXISTS "Service role can manage carts"
ON Carts FOR ALL TO service_role
USING (true) WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "Buyers can manage their own cart"
...
CREATE POLICY IF NOT EXISTS "Service role can manage cart items"
ON CartItems FOR ALL TO service_role
USING (true) WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "Buyers can manage their cart items"
...
CREATE POLICY IF NOT EXISTS "Service role can manage categories"
ON Categories FOR ALL TO service_role
USING (true) WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "Anyone can read active categories"
...
CREATE POLICY IF NOT EXISTS "Service role can manage delivery tracking"
ON DeliveryTracking FOR ALL TO service_role
USING (true) WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "Buyers can read tracking for their orders"
...
CREATE POLICY IF NOT EXISTS "Transporters can manage their delivery tracking"
...
CREATE POLICY IF NOT EXISTS "Service role can manage routes"
ON Routes FOR ALL TO service_role
USING (true) WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "Buyers can read routes for their orders"
...
CREATE POLICY IF NOT EXISTS "Transporters can read their routes"
ON Routes FOR SELECT TO authenticated
USING (auth.uid()::text = TransporterId);
