...
try
{
    using (var scope = app.Services.CreateScope())
    {
        ...
        await context.Database.ExecuteSqlRawAsync(@"
            -- Check if MasterProducts table exists, if not create it
            ...
            ) AS data WHERE NOT EXISTS (SELECT 1 FROM ""MasterProducts"" LIMIT 1);
        ...
        ");
        Console.WriteLine("✅ Master products seeded with images");
